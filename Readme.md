https://mambarinka.github.io/50026-catenergy-19/
...
[travis-image]: https://travis-ci.com/htmlacademy-adaptive/{{userId}}-{{projectName}}.svg?branch=master
[travis-url]: https://travis-ci.com/htmlacademy-adaptive/{{userId}}-{{projectName}}
[dependency-image]: https://david-dm.org/htmlacademy-adaptive/{{userId}}-{{projectName}}/dev-status.svg?style=flat-square
[dependency-url]: https://david-dm.org/htmlacademy-adaptive/{{userId}}-{{projectName}}?type=dev
